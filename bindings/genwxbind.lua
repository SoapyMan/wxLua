...
dataTypeIntTable   	= {} -- datatypes that are unsigned numbers
...
function InitDataTypes()
	...
	dataTypeIntTable["char"] 			= true;
	dataTypeIntTable["short"] 			= true;
	dataTypeIntTable["int"] 			= true;
	dataTypeIntTable["long"] 			= true;
	dataTypeIntTable["ptrdiff_t"] 		= true;
	dataTypeIntTable["voidptr_long"] 	= true;
	
	dataTypeIntTable["wxByte"] 			= true;
	dataTypeIntTable["wxWord"] 			= true;
	dataTypeIntTable["wxInt8"] 			= true;
	dataTypeIntTable["wxInt16"] 		= true;
	dataTypeIntTable["wxInt32"] 		= true;
	dataTypeIntTable["wxInt64"] 		= true;
	dataTypeIntTable["wxCoord"] 		= true;
	dataTypeIntTable["wxTextCoord"] 	= true;
	dataTypeIntTable["wxWindowID"] 		= true;
	dataTypeIntTable["wxEventType"] 	= true;
...
-- ---------------------------------------------------------------------------
-- Is this data type an signed integer
-- ---------------------------------------------------------------------------
function IsDataTypeInt(datatype)
    local dtype = GetDataTypedefBase(string.gsub(datatype, "const ", ""))
    if dtype then
        return dataTypeIntTable[dtype.Name] or false
    else
        print("ERROR: Missing data type '"..tostring(datatype).."' in IsDataTypeInt.")
    end
...
--                    end
				...
				elseif IsDataTypeInt(memberType) then
                ...
                elseif IsDataTypeInt(memberType) then
                    overload_argList = overload_argList.."&wxluatype_TINTEGER, "
                    CommentBindingTable(codeList, "    // get the signed integer value\n")
            ...
            elseif member.DefType == "deftype_method" then
                ...
                while member.Params[arg+1] do
                    ...
                    elseif indirectionCount == 0 then
		                ...
		                elseif IsDataTypeInt(argTypeWithAttrib) then
                            overload_argList = overload_argList.."&wxluatype_TINTEGER, "
                ...
                if member.IsConstructor then
                    ...
                    if not memberType or (memberTypeWithAttrib == "void") then
						...
						elseif IsDataTypeInt(member.DataType) then
                            CommentBindingTable(codeList, "    // push the result integer\n")
                            table.insert(codeList, "    lua_pushinteger(L, returns);\n")
						elseif IsDataTypeUInt(member.DataType) then
                            CommentBindingTable(codeList, "    // push the result unsigned integer\n")
                            table.insert(codeList, "    lua_pushinteger(L, returns);\n")
                        else -- Number
                            CommentBindingTable(codeList, "    // push the result number\n")
