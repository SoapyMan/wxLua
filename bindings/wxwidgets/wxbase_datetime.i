...
class %delete wxDateTime
{
	...
	wxTimeSpan& Subtract(const wxDateTime& diff );
	...
	%wxchkver_2_9 bool ParseISODate(wxString date);
	%wxchkver_2_9 bool ParseISOTime(wxString time);
	%wxchkver_2_9 bool ParseISOCombined(wxString datetime, char sep = 'T');
	...
	wxString FormatISOCombined(char sep = 'T') const; // ~ SOAP
