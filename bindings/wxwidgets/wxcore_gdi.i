...
#if wxLUA_USE_wxFontMapper && wxUSE_FONTMAP
...
#endif //wxLUA_USE_wxFontMapper && wxUSE_FONTMAP
...
class %delete wxDC : public wxObject
{
	...
	void DrawRectangle(wxRect& rect );
	...
	void DrawRoundedRectangle (const wxPoint &pt, const wxSize &sz, double radius = 20);
	void DrawRoundedRectangle (const wxRect &rect, double radius = 20)
