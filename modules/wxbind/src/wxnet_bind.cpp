...
#if (wxUSE_STREAMS) && ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL))
...
#endif // (wxUSE_STREAMS) && ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL))
...
#if (wxLUA_USE_wxSocket && wxUSE_SOCKETS) && ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL))
...
#endif // (wxLUA_USE_wxSocket && wxUSE_SOCKETS) && ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL))
...
#if ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL)))||((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL))
// function overload table
...
#endif // ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && ((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL)))||((wxLUA_USE_wxSocket && wxUSE_SOCKETS) && (wxUSE_URL))
