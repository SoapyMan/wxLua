...
#if (wxLUA_USE_wxFileName) && (wxLUA_USE_wxArrayString)
...
#endif // (wxLUA_USE_wxFileName) && (wxLUA_USE_wxArrayString)
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxFileName_GetHumanReadableSize[] = { &wxluatype_wxFileName, &wxluatype_TSTRING, &wxluatype_TINTEGER, NULL };
...
#if (wxLUA_USE_wxFileName) && (wxLUA_USE_wxDateTime && wxUSE_DATETIME)
...
#endif // (wxLUA_USE_wxFileName) && (wxLUA_USE_wxDateTime && wxUSE_DATETIME)
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxFileName_IsPathSeparator[] = { &wxluatype_TINTEGER, &wxluatype_TINTEGER, NULL };
...
static int LUACALL wxLua_wxFileName_IsPathSeparator(lua_State *L)
{
    ...
    wxPathFormat format = (argCount >= 2 ? (wxPathFormat)wxlua_getenumtype(L, 2) : wxPATH_NATIVE);
    // int ch
    int ch = (int)wxlua_getintegertype(L, 1);
...
static int LUACALL wxLua_wxFileName_Mkdir1(lua_State *L)
{
    ...
    // int perm = 4095
    int perm = (argCount >= 2 ? (int)wxlua_getintegertype(L, 2) : 4095);
    // const wxString dir
    const wxString dir = wxlua_getwxStringtype(L, 1);
    // call Mkdir
...
{
    // int fd
    int fd = (int)wxlua_getintegertype(L, 2);
    // get this
...
#if ((wxLUA_USE_wxDir) && (wxCHECK_VERSION(2,8,0))) && (wxUSE_LONGLONG)
...
#endif // ((wxLUA_USE_wxDir) && (wxCHECK_VERSION(2,8,0))) && (wxUSE_LONGLONG)
...
#if (wxUSE_MIMETYPE) && (wxLUA_USE_wxArrayString)
...
#endif // (wxUSE_MIMETYPE) && (wxLUA_USE_wxArrayString)
...
#if (wxUSE_MIMETYPE)||((wxUSE_MIMETYPE) && (wxLUA_USE_wxArrayString))
// function overload table
...
#endif // (wxUSE_MIMETYPE)||((wxUSE_MIMETYPE) && (wxLUA_USE_wxArrayString))
...
#if (!wxCHECK_VERSION(2,9,0)) && (wxUSE_MIMETYPE)
...
#endif // (!wxCHECK_VERSION(2,9,0)) && (wxUSE_MIMETYPE)
