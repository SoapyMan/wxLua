...
#if (wxUSE_LONGLONG) && ((wxLUA_USE_wxFileName) && (wxCHECK_VERSION(2,8,0)))
...
#endif // (wxUSE_LONGLONG) && ((wxLUA_USE_wxFileName) && (wxCHECK_VERSION(2,8,0)))
...
#if ((wxLUA_USE_wxDateTime && wxUSE_DATETIME) && (wxUSE_STREAMS)) && ((wxUSE_STREAMS) && (wxUSE_FILESYSTEM))
...
#endif // ((wxLUA_USE_wxDateTime && wxUSE_DATETIME) && (wxUSE_STREAMS)) && ((wxUSE_STREAMS) && (wxUSE_FILESYSTEM))
