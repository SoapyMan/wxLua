...
#if (wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_Geometry && wxUSE_GEOMETRY)
...
#endif // (wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_Geometry && wxUSE_GEOMETRY)
...
#if ((wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_Geometry && wxUSE_GEOMETRY))||(wxLUA_USE_Geometry && wxUSE_GEOMETRY)
...
#endif // ((wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_Geometry && wxUSE_GEOMETRY))||(wxLUA_USE_Geometry && wxUSE_GEOMETRY)
