...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDialog_Create[] = { &wxluatype_wxDialog, &wxluatype_wxWindow, &wxluatype_TINTEGER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
#if ((wxUSE_BUTTON) && (wxLUA_USE_wxDialog)) && ((wxLUA_USE_wxSizer) && (wxCHECK_VERSION(2,8,0)))
...
#endif // ((wxUSE_BUTTON) && (wxLUA_USE_wxDialog)) && ((wxLUA_USE_wxSizer) && (wxCHECK_VERSION(2,8,0)))

#if ((wxCHECK_VERSION(2,8,0) && wxUSE_BUTTON) && (wxLUA_USE_wxDialog)) && ((wxLUA_USE_wxSizer) && (wxCHECK_VERSION(2,8,0)))
...
#endif // ((wxCHECK_VERSION(2,8,0) && wxUSE_BUTTON) && (wxLUA_USE_wxDialog)) && ((wxLUA_USE_wxSizer) && (wxCHECK_VERSION(2,8,0)))

#if ((wxUSE_BUTTON) && (wxLUA_USE_wxDialog)) && ((wxLUA_USE_wxSizer) && (wxCHECK_VERSION(2,8,0)) && (wxUSE_BUTTON))
...
#endif // ((wxUSE_BUTTON) && (wxLUA_USE_wxDialog)) && ((wxLUA_USE_wxSizer) && (wxCHECK_VERSION(2,8,0)) && (wxUSE_BUTTON))
...
#if (wxLUA_USE_wxDialog) && (wxLUA_USE_wxPointSizeRect)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDialog_constructor1[] = { &wxluatype_wxWindow, &wxluatype_TINTEGER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
#if (!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxFileDialog && wxUSE_FILEDLG)
static wxLuaArgType s_wxluatypeArray_wxLua_wxFileDialog_SetStyle[] = { &wxluatype_wxFileDialog, &wxluatype_TINTEGER, NULL };
...
#if ((wxLUA_USE_wxFileDialog && wxUSE_FILEDLG) && (wxLUA_USE_wxPointSizeRect)) && ((!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxFileDialog && wxUSE_FILEDLG))
static wxLuaArgType s_wxluatypeArray_wxLua_wxFileDialog_constructor[] = { &wxluatype_wxWindow, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_TINTEGER, &wxluatype_wxPoint, NULL };
static int LUACALL wxLua_wxFileDialog_constructor(lua_State *L);
...
#endif // ((wxLUA_USE_wxFileDialog && wxUSE_FILEDLG) && (wxLUA_USE_wxPointSizeRect)) && ((!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxFileDialog && wxUSE_FILEDLG))
...
#elif ((wxLUA_USE_wxFileDialog && wxUSE_FILEDLG) && (wxLUA_USE_wxPointSizeRect)) && ((!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxFileDialog && wxUSE_FILEDLG))
    { "wxFileDialog", WXLUAMETHOD_CONSTRUCTOR, s_wxluafunc_wxLua_wxFileDialog_constructor, 1, NULL },
#endif // ((wxLUA_USE_wxFileDialog && wxUSE_FILEDLG) && (wxLUA_USE_wxPointSizeRect)) && ((!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxFileDialog && wxUSE_FILEDLG))
    { 0, 0, 0, 0 },
};
...
#if (!wxCHECK_VERSION(2,8,0)) && (wxLUA_USE_wxDirDialog && wxUSE_DIRDLG)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDirDialog_SetStyle[] = { &wxluatype_wxDirDialog, &wxluatype_TINTEGER, NULL };
...
#if (wxUSE_CHOICEDLG && wxLUA_USE_wxMultiChoiceDialog) && (wxLUA_USE_wxArrayInt)
...
#endif // (wxUSE_CHOICEDLG && wxLUA_USE_wxMultiChoiceDialog) && (wxLUA_USE_wxArrayInt)

#if ((wxUSE_CHOICEDLG && wxLUA_USE_wxMultiChoiceDialog) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_wxArrayString)
...
#endif // ((wxUSE_CHOICEDLG && wxLUA_USE_wxMultiChoiceDialog) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_wxArrayString)
...
#if ((wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_wxArrayString)) && (wxUSE_CHOICEDLG && wxLUA_USE_wxSingleChoiceDialog)
...
#endif // ((wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_wxArrayString)) && (wxUSE_CHOICEDLG && wxLUA_USE_wxSingleChoiceDialog)
...
#if (wxUSE_FONTDLG && wxLUA_USE_wxFontDialog) && (wxLUA_USE_wxFont)
...
#endif // (wxUSE_FONTDLG && wxLUA_USE_wxFontDialog) && (wxLUA_USE_wxFont)

#if (wxUSE_FONTDLG && wxLUA_USE_wxFontDialog) && (wxLUA_USE_wxColourPenBrush)
...
#endif // (wxUSE_FONTDLG && wxLUA_USE_wxFontDialog) && (wxLUA_USE_wxColourPenBrush)
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxFindDialogEvent_constructor[] = { &wxluatype_TINTEGER, &wxluatype_TINTEGER, NULL };
...
// ---------------------------------------------------------------------------
// Bind class wxNotificationMessage
// ---------------------------------------------------------------------------

// Lua MetaTable Tag for Class 'wxNotificationMessage'
int wxluatype_wxNotificationMessage = WXLUA_TUNKNOWN;

static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_AlwaysUseGeneric[] = { &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxNotificationMessage_AlwaysUseGeneric(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_AlwaysUseGeneric[1] = {{ wxLua_wxNotificationMessage_AlwaysUseGeneric, WXLUAMETHOD_METHOD|WXLUAMETHOD_STATIC, 1, 1, s_wxluatypeArray_wxLua_wxNotificationMessage_AlwaysUseGeneric }};
// 	static void AlwaysUseGeneric(bool alwaysUseGeneric)
static int LUACALL wxLua_wxNotificationMessage_AlwaysUseGeneric(lua_State *L)
{
    // bool alwaysUseGeneric
    bool alwaysUseGeneric = wxlua_getbooleantype(L, 1);
    // call AlwaysUseGeneric
    wxNotificationMessage::AlwaysUseGeneric(alwaysUseGeneric);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_Close[] = { &wxluatype_wxNotificationMessage, NULL };
static int LUACALL wxLua_wxNotificationMessage_Close(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_Close[1] = {{ wxLua_wxNotificationMessage_Close, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxNotificationMessage_Close }};
//     bool Close();
static int LUACALL wxLua_wxNotificationMessage_Close(lua_State *L)
{
    // get this
    wxNotificationMessage * self = (wxNotificationMessage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxNotificationMessage);
    // call Close
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_SetFlags[] = { &wxluatype_wxNotificationMessage, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxNotificationMessage_SetFlags(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_SetFlags[1] = {{ wxLua_wxNotificationMessage_SetFlags, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxNotificationMessage_SetFlags }};
//     void SetFlags(int flags);
static int LUACALL wxLua_wxNotificationMessage_SetFlags(lua_State *L)
{
    // int flags
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_SetMessage[] = { &wxluatype_wxNotificationMessage, &wxluatype_TSTRING, NULL };
static int LUACALL wxLua_wxNotificationMessage_SetMessage(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_SetMessage[1] = {{ wxLua_wxNotificationMessage_SetMessage, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxNotificationMessage_SetMessage }};
//     void SetMessage(const wxString& message);
static int LUACALL wxLua_wxNotificationMessage_SetMessage(lua_State *L)
{
    // const wxString message
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_SetParent[] = { &wxluatype_wxNotificationMessage, &wxluatype_wxWindow, NULL };
static int LUACALL wxLua_wxNotificationMessage_SetParent(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_SetParent[1] = {{ wxLua_wxNotificationMessage_SetParent, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxNotificationMessage_SetParent }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_SetTitle[] = { &wxluatype_wxNotificationMessage, &wxluatype_TSTRING, NULL };
static int LUACALL wxLua_wxNotificationMessage_SetTitle(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_SetTitle[1] = {{ wxLua_wxNotificationMessage_SetTitle, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxNotificationMessage_SetTitle }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_Show[] = { &wxluatype_wxNotificationMessage, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxNotificationMessage_Show(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_Show[1] = {{ wxLua_wxNotificationMessage_Show, WXLUAMETHOD_METHOD, 1, 2, s_wxluatypeArray_wxLua_wxNotificationMessage_Show }};
...
static int LUACALL wxLua_wxNotificationMessage_Show(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int timeout = -1
    int timeout = (argCount >= 2 ? (int)wxlua_getintegertype(L, 2) : -1);
    // get this
    wxNotificationMessage * self = (wxNotificationMessage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxNotificationMessage);
    // call Show
    bool returns = (self->Show(timeout));
    // push the result flag
    lua_pushboolean(L, returns);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxNotificationMessage_constructor[] = { &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_wxWindow, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxNotificationMessage_constructor(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxNotificationMessage_constructor[1] = {{ wxLua_wxNotificationMessage_constructor, WXLUAMETHOD_CONSTRUCTOR, 1, 4, s_wxluatypeArray_wxLua_wxNotificationMessage_constructor }};
...
static int LUACALL wxLua_wxNotificationMessage_constructor(lua_State *L)
{
    ...
    int flags = (argCount >= 4 ? (int)wxlua_getintegertype(L, 4) : wxICON_INFORMATION);
    // wxWindow parent = NULL
    wxWindow * parent = (argCount >= 3 ? (wxWindow *)wxluaT_getuserdatatype(L, 3, wxluatype_wxWindow) : NULL);
    // const wxString message = wxEmptyString
    const wxString message = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : wxString(wxEmptyString));
    // const wxString title
    const wxString title = wxlua_getwxStringtype(L, 1);
    // call constructor
    wxNotificationMessage* returns = new wxNotificationMessage(title, message, parent, flags);
    // push the constructed class pointer
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxNotificationMessage);
...
void wxLua_wxNotificationMessage_delete_function(void** p)
{
    wxNotificationMessage* o = (wxNotificationMessage*)(*p);
    delete o;
}

// Map Lua Class Methods to C Binding Functions
wxLuaBindMethod wxNotificationMessage_methods[] = {
    { "AlwaysUseGeneric", WXLUAMETHOD_METHOD|WXLUAMETHOD_STATIC, s_wxluafunc_wxLua_wxNotificationMessage_AlwaysUseGeneric, 1, NULL },
    { "Close", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxNotificationMessage_Close, 1, NULL },
    { "SetFlags", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxNotificationMessage_SetFlags, 1, NULL },
    { "SetMessage", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxNotificationMessage_SetMessage, 1, NULL },
    { "SetParent", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxNotificationMessage_SetParent, 1, NULL },
    { "SetTitle", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxNotificationMessage_SetTitle, 1, NULL },
    { "Show", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxNotificationMessage_Show, 1, NULL },
    { "wxNotificationMessage", WXLUAMETHOD_CONSTRUCTOR, s_wxluafunc_wxLua_wxNotificationMessage_constructor, 1, NULL },

    { 0, 0, 0, 0 },
};

int wxNotificationMessage_methodCount = sizeof(wxNotificationMessage_methods)/sizeof(wxLuaBindMethod) - 1;
