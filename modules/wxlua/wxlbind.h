...
struct wxlFoundMethod
{
	wxlFoundMethod(wxLuaBindMethod* m, int d) : method(m), depth(d) {}
	wxLuaBindMethod*	method;
	short				depth;
};
...
public:
    ...
    static wxlFoundMethod GetClassMethod_r(const wxLuaBindClass *wxlClass, const char *methodName,
                                           int method_type, int depth);
